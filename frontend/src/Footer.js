          ...
          <MDBRow className='mt-3'>
            ...
            <MDBCol md='4' lg='3' xl='3' className='mx-auto mb-md-0 mb-4'>
              ...
              <p>
                ...
                Kolkata, Rajarhat, West Bengal
              </p>
              <p>
                <MDBIcon color='light' icon='envelope' className='me-3' />
                anvesh99kumar@gmail.com
              </p>
              <p>
                <MDBIcon color='light' icon='phone' className='me-3' /> +917023460103
              </p>
              <p>
                <MDBIcon color='light' icon='print' className='me-3' /> +917488099910
              </p>
            </MDBCol>
          </MDBRow>
        </MDBContainer>
